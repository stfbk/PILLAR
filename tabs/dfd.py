...
""")
    ...
    edges = st.data_editor(
        ...
        column_config={
            ...
            "trusted": st.column_config.CheckboxColumn("Trusted", help="Whether the edge stays inside the trusted boundary (true) or traverses it (false).", width="medium", required=True, default=True),
        },
        key="edges",
        num_rows="dynamic",
